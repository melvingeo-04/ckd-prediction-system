...
FEATURE_LABELS = {
    ...
    "sc":"Serum Creatinine (mgs/dl)","bu":"Blood Urea (mgs/dl)",
    "hemo":"Hemoglobin (gms)","bgr":"Blood Glucose Random (mgs/dl)",
    "al":"Albumin","sg":"Specific Gravity",
    "htn":"Hypertension","dm":"Diabetes Mellitus",
}
ALL_FEATURES = ["age","bp","sg","al","su","rbc","pc","pcc","ba","bgr",
                "bu","sc","sod","pot","hemo","pcv","wbcc","rbcc","htn","dm",
                "cad","appet","pe","ane"]
DEFAULTS = {"su":0,"rbc":1,"pc":1,"pcc":0,"ba":0,"sod":135,"pot":4.5,
            "pcv":44,"wbcc":7800,"rbcc":5.2,"cad":0,"appet":1,"pe":0,"ane":0}
